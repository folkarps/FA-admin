...
def main():
    ...
    print("""
  ######################################
  # FA Development Environment Setup #
  ######################################

  This script will create your FA dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your FA project folder:
    [Arma 3 installation directory]\\{} => FA project folder
    P:\\{}                              => FA project folder
